...
public static partial class PathManager
{
    ...
    private static string LinuxDolphinFlatpakAppDataFolderPath =>
        Path.Combine(
            HomeFolderPath,
            ".var",
            "app",
    ...
    public static string LinuxFlatpakBundledDolphinXdgConfigDir =>
        Path.Combine(
            HomeFolderPath,
            ".var",
            "app",
    ...
    public static string LinuxFlatpakBundledDolphinXdgDataDir =>
        Path.Combine(
            HomeFolderPath,
            ".var",
            "app",
    ...
    public static string WheelWizardFlatpakAppId =>
        Environment.GetEnvironmentVariable("FLATPAK_ID") ?? "io.github.TeamWheelWizard.WheelWizard";
